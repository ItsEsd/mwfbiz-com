// var public_spreadsheet_url = '1nWQyrsjM9tYEUZkjYkxtL9Fh3T3cJcz3xbLhsdHTYoA'; function init() { Tabletop.init({ key: public_spreadsheet_url, callback: showInfo, simpleSheet: true }); } function showInfo(data) { var z; for (z = 0; z < data.length; z++) { document.getElementById("PSpgProfile").innerHTML += '<a href=' + data[z].PLink + ' target="_parent">' + '<div class="item4">' + '<div align="center" >' + '<img src=' + data[z].ImageLink + '>' + '<b>' + '<div class="Name">' + data[z].Name + '</b>' + '<b>' + '<div class="Bio">' + data[z].Bio + '</b>' + '</div>' + '</div>' + '</div>' + '</div>' + '</a>'; } } init();
$(document).ready( function(){
    var url1 = "https://script.google.com/macros/s/";
    var url2 = "AKfycbyh_N5MPDhyZGl8AHn1qT-VLC0Urz0sy_S3RA2kkN6shjf0Qky75gVwey9UDai_Njpo";
    var url = url1+url2+"/exec"+ "?action=readsg";
