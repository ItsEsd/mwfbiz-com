...
veremail.addEventListener('submit', (event) => {
  if (document.getElementById('vercode').value == document.getElementById('vercodepre').value) {
...
var ewfSetCookie = function(exdays,uid) {
  ...
  document.cookie = "_ybizc0="+uid+"; expires=" + expires + ";path=/;domain=mwfbiz.com";
};
if (ewf_expire) {
...
$('#loginmwf').on('click', function(e) {
  $('#formsign').hide();
  $('#logmwf').show();$('.bizfacecon-tw').slideDown();
});
...
logmwf.addEventListener('submit', (event) => {
  ...
  if (email1 != 0 && pass != 0) {
    ...
    var ur2 = "AKfycbxp0lzI_pWOpQlmbLoWC6_HM2lTCa6OxzOa1aba3gM2wc4bH3t-BXGA10cFbNXcOCU9Ng";
    var urbit = ur1 + ur2 + "/exec";
    var url = urbit + "?callback=userfound&heid=" + email1 + "&hepass=" + pass + "&action=hellobiz";
...
function userfound(e) {
  ...
  if (res != "ID not found!") {
    ...
    // document.getElementById("logmwf").style.display = 'block';
    document.getElementById("loader").style.display = "none";
